...
- If you are new to the project, please check out the [good first issue](https://github.com/whiteducksoftware/azctx/labels/good%20first%20issue) label.
- If you are looking for something to work on, check out our [open issues](https://github.com/whiteducksoftware/azctx/issues).
...
Releases of `azctx` are done using [GoReleaser](https://goreleaser.com/). The workflow looks like this:
